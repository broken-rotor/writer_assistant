...
from app.models.worldbuilding_models import (
    WorldbuildingResponse, WorldbuildingChatContext, FollowupQuestion
)
...
async def _handle_worldbuilding_chat(request: LLMChatRequest, llm) -> LLMChatResponse:
    ...
    if context:
        ...
        llm_messages.append({"role": "assistant", "content": "I understand the context. How can I help you with your worldbuilding?"})
    ...
    metadata = {
        ...
        "worldbuilding": {
            ...
            "overallProgress": sum(
                ctx.completeness_score for ctx in updated_state.branches[updated_state.current_branch_id].topic_contexts.values()
