...
export class ReviewService {
  ...
  getAvailableReviews(storyId: string, chapterNumber: number): ReviewItem[] {
    ...
    // Reviews should be managed through a different mechanism now
    return [];
  }
  ...
  markReviewsAsApplied(storyId: string, reviewIds: string[]): void {
    ...
    // Chapter compose has been removed
    // Review application should be managed through a different mechanism now
  ...
  private storeReviews(storyId: string, chapterNumber: number, reviews: ReviewItem[]): void {
    ...
    // Chapter compose has been removed
    // Reviews are now managed through the cache only
  }
